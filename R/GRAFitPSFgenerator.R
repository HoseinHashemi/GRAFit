GRAFitPSFgenerator <- function(wrk_dir = wrk_dir, GRAFitlib = GRAFitlib, output_dir = output_dir, data_dir = data_dir, 
                               PSF_name = "psf", target_loc, loc_Unit = c("xy","deg"), CCDCHIP, filter, EXPSTART, jitter, 
