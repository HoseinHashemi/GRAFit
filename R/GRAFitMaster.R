...
GRAFitMaster <- function( wrk_dir = NULL, data_dir = NULL, GRAFitlib = NULL, PSF_dir = NULL, object_list = NULL,
  ...
  foreach (j = 1:NROW(object_list)) %dopar% {     # Loop on all objects. ,.errorhandling="pass" , .combine = 'cbind', .multicombine = TRUE
    ...
    tryCatch({
      ...
      error = "ERROR in: loading packages"
      library(devtools)
      library(astro)
      library(ProFound)
      library(FITSio)
      ...
      # lapply(paste(GRAFitlib,list.files(path = GRAFitlib, pattern = "[.][rR]$", recursive = TRUE), sep = ''), source)
      # sourceDirectory(GRAFitlib, modifiedOnly=TRUE)
      source(paste(GRAFitlib,'/GRAFitAperturePlot.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitTinyTimACS.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitSBprofile.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitFrameCenFinder.R',sep=''))
      source(paste(GRAFitlib,'/myPlotSegIm.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitMainFinder.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitSBdistr.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitImager.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitDynamo.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitDynamo_v2.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitFrameFinder.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitFrameFinder_v2.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitPSFgenerator.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitAddFakeBulge.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitInitModelSetup.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitInitModelSetupConst.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitOptim.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitLA.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitLD.R',sep=''))
      ...
      source(paste(GRAFitlib,'/GRAFitPSFkernelConv.R',sep=''))
      source(paste(GRAFitlib,'/GRAFitImage.R',sep=''))
