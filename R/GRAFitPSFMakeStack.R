#' GRAFit: Stack Four HST/ACS PSFs
#'
#' @description This function stacks four HST/ACS PSFs.
#' @param psf1,psf2,psf3,psf4 PSFs
#' @return A stacked PSF.
#' @author Hosein Hashemizadeh
#' @seealso \code{\link[GRAFit]{GRAFitPSFgenerator}}, \code{\link[GRAFit]{GRAFitTinyTimACS}}
#' @examples -
#' @export
