GRAFitInitModelSetupConst <- function( output_dir = NULL, GRAFitlib = GRAFitlib, main_src = NULL, nComp = 2, 
                                  ExpDisk = FALSE, FreeBulge = FALSE, BulgeFreeness = 0, BT_flux_ratio = 0.2, 
  ...
  if (nComp == 2) {
    ...
    # if (modellist$sersic$re[2] < 1)  modellist$sersic$re[2] = 1
    # if (modellist$sersic$re[1] < 1)  modellist$sersic$re[1] = 1
