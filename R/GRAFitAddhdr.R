#' GRAFit: Add Header to the Output Catalogue.
#'
#' @description This function adds a header to the output catalogue.
#' @param out_catalog The direction to the catalogue for which the header needs to be appended.
...
GRAFitAddhdr <- function(out_catalog) {
    ...
    header <- c("CATAID", "G10ID", "z", "LookBackT", "RA", "DEC",
